 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class oer_resource_removed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoerresourceremoved', 'mod_oercollection');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' removed an OER resource from the collection with the id '$this->objectid'.";
    }
