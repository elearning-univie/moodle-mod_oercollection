...
/**
 * Languages configuration for the mod_oercollection plugin.
 *
...
$string['displaymode_help'] = 'If you choose to display the contents of an OER Collection on a course page, there will be no link to a separate page. (This is not recommended for large collections with many resources!) The description will be displayed only if \'Display description on course page\' is ticked. Note that participants view actions cannot be logged in this case.';
$string['newpage'] = 'On new page';
$string['thispage'] = 'On course page';
...
$string['oercollectionname'] = 'OER Collection name';
...
<ol>
  <li>Enter a search term and select an optional filter(s) if desired.</li>
  <li>Select suitable resources.</li>
  <li>Add contextualisation.</li>
</ol>
<hr>
<ul>
<li>Would you like to <strong>publish your own OER</strong>? <a href="https://uoer.univie.ac.at/">This way</a></li>
<li>Would you like to be <strong>certified as an OER practitioner</strong>? <a href="https://oer.univie.ac.at/weiterbildungsangebote/">This way</a></li></details>';
...
<p title=""></p>
<p>The Open Educational Resources (OER) shown here are made available to you via the OERhub - the open search engine for OER from the Austrian higher education sector. As a student, you can use the OERhub to research further materials, but also for personal further education.</p>
<ul>
<li><a href="https://oerhub.at">This way to the OERhub</a></li>
<li><a href="https://wiki.univie.ac.at/pages/viewpage.action?pageId=176658343">Find out more about OER here</a></li></p></details>';
...
$string['insertafter'] = 'Insert resource before:';
...
$string['multiaddedinfomessage'] = '{$a->added} resource(s) has(have) been added to the collection. <br> {$a->notadded} resource(s) already exist(s) in the collection.';
